...
function Experince() {
    const ExperinceBlocksData: { whenIWorkedThere: string, title: string, subTitle: string, subTitleColor: string, image: string, url: string, para: string }[] = [
        { whenIWorkedThere: 'July 2019 - August 2019', title: 'Kinaxis', subTitle: 'Front End Summer Intership', subTitleColor: '#dc1d2d', image: KinaxisImage, url: 'https://www.kinaxis.com/en', para: 'My role at kinaxis was to develop Internal Tools. We started the year converting there career page to use an API to allow HR to put up /take down instead of the current situation having to ask marketing to put up the job which could take days to happen.' },
